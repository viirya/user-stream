...
function Stream(params) {
    ...
    params['req_params'] = '';
    if ('api_params' in params) {
        var params_str = '';
        for (var key in params['api_params']) {
            if (params_str != '') {
                params_str += '&';
            }
            params_str += (key + '=' + params['api_params'][key]);
        }
        params['req_params'] = '?' + params_str;
    }
...
Stream.prototype.stream = function() {
    ...
    var request = this.oauth.post(
        twitter_apis[this.params.api] + this.params['req_params'],
